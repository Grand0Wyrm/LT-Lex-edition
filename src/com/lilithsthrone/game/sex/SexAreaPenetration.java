			...
			if(targetArea.isPenetration()) {
				switch((SexAreaPenetration)targetArea) {
					case CLIT:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.cock+] pressed against [npc2.namePos] [npc2.clit+].");
							} else {
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")+" as [npc.namePos] slid [npc.her] [npc.cock] over [npc2.her] [npc2.clit].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case FINGER:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc2.namePos] wrapped [npc2.her] [npc2.fingers+] around [npc.her] [npc.cock+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while keeping [npc2.her] [npc2.fingers] wrapped around [npc.namePos] [npc.cock+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case FOOT:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append((performer.isAsleep()?"Remaining deeply asleep":"Without making a move")+", [npc.name] kept [npc.her] [npc.cock+] pressed against [npc2.namePos] [npc2.feet].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep":"remained totally inanimate")+" as [npc2.her] [npc2.feet+] were used to pleasure [npc.name].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append((performer.isAsleep()?"Remaining deeply asleep":"Remaining as still as a statue")+", [npc.name] kept [npc.her] [npc.cock+] pressed against [npc2.namePos] own [npc2.cock].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep":"didn't react or move at all")+" as [npc2.her] [npc2.cock+] was used in such a manner.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case TAIL:
						...
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc2.namePos] wrapped [npc2.her] [npc2.tail+] around [npc.her] [npc.cock+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while wrapping [npc2.her] "+(multipleTails?"[npc2.tails+]":"[npc2.tail+]")+" around [npc.namePos] [npc.cock+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case TENTACLE:
						...
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc2.namePos] wrapped [npc2.her] [npc2.tentacle+] around [npc.her] [npc.cock+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while wrapping [npc2.her] "+(multipleTentacles?"[npc2.tentacles+]":"[npc2.tentacle+]")+" around [npc.namePos] [npc.cock+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case TONGUE:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append((performer.isAsleep()?"Remaining deeply asleep, [npc.name] didn't come close to waking up":"Continuing to act like an inanimate sex doll, [npc.name] kept perfectly still")
										+" as [npc2.namePos] [npc2.tongue+] licked and lapped at [npc.her] [npc.cock+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep":"remained totally motionless")+" while keeping [npc2.her] [npc2.tongue] pressed against [npc.namePos] [npc.cock].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
				...
				switch((SexAreaOrifice)targetArea) {
					case ANUS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] hilted in [npc2.namePos] [npc2.asshole+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] [npc2.asshole+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case ASS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] pushed up between [npc2.namePos] ass cheeks.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] used [npc2.her] [npc2.ass+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case ARMPITS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] pushed up against [npc2.namePos] [npc2.armpit+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] used [npc2.her] [npc2.armpit+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case BREAST:
						...
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								if(paizuri) {
									sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] pushed up between [npc2.namePos] [npc2.breasts+].");
								} else {
									sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] pressed against [npc2.namePos] [npc2.breasts+].");
								}
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] used [npc2.her] [npc2.breasts+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case BREAST_CROTCH:
						...
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								if(crotchPaizuri) {
									sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] pushed up between [npc2.namePos] [npc2.crotchBoobs+].");
								} else {
									sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] pressed against [npc2.namePos] [npc2.crotchBoobs+].");
								}
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] used [npc2.her] [npc2.crotchBoobs+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case MOUTH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] hilted down [npc2.namePos] throat.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] face.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] hilted in one of [npc2.namePos] [npc2.nipples+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] sunk [npc.her] [npc.cock+] deep into [npc2.her] [npc2.nipple(true)].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE_CROTCH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] hilted in one of [npc2.namePos] [npc2.crotchNipples+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
									...
									case DOM_ROUGH:
										...
										break;
									case SUB_RESISTING:
										sb.append("[npc.Name] tried to resist, but [npc.was] unable to stop [npc2.name] from making [npc.herHim] penetrate and fuck [npc2.her] [npc2.crotchNipple(true)].");
										break;
								}
							}
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] sunk [npc.her] [npc.cock+] deep into [npc2.her] [npc2.crotchNipple(true)].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
									...
									case SUB_NORMAL:
									case DOM_ROUGH:
										sb.append(" [npc2.Name] [npc2.sexPaceVerb] pushed out [npc2.her] groin on every thrust, [npc2.moaning+] as [npc2.she] helped to sink [npc.namePos] [npc.cock+] deep into [npc2.her] [npc2.crotchNipple(true)].");
										break;
									case SUB_RESISTING:
										sb.append(" [npc2.Name] tried to pull away, but [npc.name] [npc.was] able to keep [npc2.herHim] in place even while [npc.her] [npc.cock+] thrust in and out of [npc2.her] [npc2.crotchNipple(true)].");
										break;
								}
							}
					...
					case THIGHS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] pushed between [npc2.namePos] thighs.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] thighs.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case URETHRA_PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] hilted in [npc2.namePos] [npc2.penisUrethra+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] [npc2.penisUrethra+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case URETHRA_VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] hilted in [npc2.namePos] [npc2.vaginaUrethra+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] [npc2.vaginaUrethra+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] hilted in [npc2.namePos] [npc2.pussy+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] [npc2.pussy+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case SPINNERET:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.cock+] hilted in [npc2.namePos] [npc2.spinneret+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] [npc2.spinneret+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
			...
			if(targetArea.isPenetration()) {
				switch((SexAreaPenetration)targetArea) {
					case CLIT:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.clit+] pressed against [npc2.namePos] [npc2.pussy+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")
										+" as [npc.namePos] slid [npc.her] [npc.clit] over [npc2.her] [npc2.pussy].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
				...
				switch((SexAreaOrifice)targetArea) {
					case ARMPITS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] pushed up against [npc2.namePos] [npc2.armpit+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
									...
									case SUB_NORMAL:
									case DOM_ROUGH:
										sb.append("Getting [npc2.name] to hold [npc2.her] [npc2.arm] up, [npc.name] [npc.was] able to slide [npc.her] [npc.clit+] up and down over [npc2.her] armpit.");
										break;
									case SUB_RESISTING:
										sb.append("Although [npc.she] tried to resist, [npc.name] [npc.was] forced to slide [npc.her] [npc.clit+] up and down over [npc2.namePos] armpit.");
										break;
								}
							}
							if(isCharacterInanimate(target)) {
								...
								switch(targetPace) {
									...
									case SUB_NORMAL:
									case DOM_ROUGH:
										sb.append(" Holding [npc2.her] [npc2.arm] up, [npc2.name] [npc2.was] soon [npc2.moaning] as [npc2.she] [npc2.sexPaceVerb] forced [npc.namePos] [npc.clit] over [npc2.her] [npc2.armpit+].");
										break;
									case SUB_RESISTING:
										sb.append(" Sobbing and crying, [npc2.name] did [npc2.her] best to pull away from [npc.name], but ended up being held in place and having [npc2.her] [npc2.armpits] fucked against [npc2.her] will.");
										break;
							...
							sb.append("[npc.NameIs] [npc.sexPaceVerb] sliding [npc.her] [npc.clit+] over [npc2.namePos] armpit.");
						}
						break;
					case ANUS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] hilted in [npc2.namePos] [npc2.asshole+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case ASS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] pushed up between [npc2.namePos] ass cheeks.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case BREAST:
						...
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								if(paizuri) {
									sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] pushed up between [npc2.namePos] [npc2.breasts+].");
								} else {
									sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] pressed against [npc2.namePos] [npc2.breasts+].");
								}
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
					...
					case BREAST_CROTCH:
						...
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								if(crotchPaizuri) {
									sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] pushed up between [npc2.namePos] [npc2.crotchBoobs+].");
								} else {
									sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] pressed against [npc2.namePos] [npc2.crotchBoobs+].");
								}
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] performed crotch-paizuri on [npc2.herHim].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case MOUTH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] hilted down [npc2.namePos] throat.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] hilted in one of [npc2.namePos] [npc2.nipples+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] [npc2.nipple(true)].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE_CROTCH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] hilted in one of [npc2.namePos] [npc2.crotchNipples+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] [npc2.crotchNipple(true)].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
									...
									case SUB_NORMAL:
									case DOM_ROUGH:
										sb.append(" [npc2.Name] [npc2.sexPaceVerb] pushed out [npc2.her] groin on every thrust, [npc2.moaning+] as [npc2.she] helped to sink [npc.namePos] [npc.clit+] deep into [npc2.her] [npc2.crotchNipple(true)].");
										break;
									case SUB_RESISTING:
										sb.append(" [npc2.Name] tried to pull away, but [npc.name] [npc.was] able to keep [npc2.herHim] in place even while [npc.her] [npc.clit+] thrust in and out of [npc2.her] [npc2.crotchNipple(true)+].");
										break;
								}
							}
					...
					case THIGHS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] pushed between [npc2.namePos] thighs.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] used [npc2.her] [npc2.legs+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case URETHRA_PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] hilted in [npc2.namePos] [npc2.penisUrethra+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case URETHRA_VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] hilted in [npc2.namePos] [npc2.vaginaUrethra+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] hilted in [npc2.namePos] [npc2.pussy+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case SPINNERET:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.clit+] hilted in [npc2.namePos] spinneret.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fucked [npc2.her] spinneret.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
			...
			if(targetArea.isPenetration()) {
				...
				switch((SexAreaOrifice)targetArea) {
					case ARMPITS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tongue+] pressed against [npc2.namePos] [npc2.armpit+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] licked [npc2.her] [npc2.armpit+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case ANUS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.lips+] pressed against [npc2.namePos] [npc2.asshole+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] performed anilingus on [npc2.herHim].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case BREAST:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.lips+] pressed against [npc2.namePos] [npc2.breast+(true)].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] kissed [npc2.her] [npc2.breasts+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case BREAST_CROTCH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.lips+] pressed against [npc2.namePos] [npc2.crotchBoob+(true)].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] kissed [npc2.her] [npc2.crotchBoobs+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case MOUTH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.lips+] pressed against [npc2.namePos] mouth.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] thrust [npc2.her] [npc2.tongue] into [npc.her] [npc.mouth].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.lips+] wrapped around [npc2.namePos] [npc2.nipple+(true)].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] kissed and licked [npc2.her] [npc2.nipples+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE_CROTCH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.lips+] wrapped around [npc2.namePos] [npc2.crotchNipples+(true)].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] kissed and licked [npc2.her] [npc2.crotchNipples+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.lips+] pressed against [npc2.namePos] [npc2.pussy+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] performed cunnilingus on [npc2.herHim].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case SPINNERET:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.lips+] pressed against [npc2.namePos] spinneret.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] orally worshipped [npc2.her] web-spinning orifice.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
			...
			if(targetArea.isPenetration()) {
				switch((SexAreaPenetration)targetArea) {
					...
					case FINGER:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.fingers+] wrapped around [npc2.namePos] [npc2.hand+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
									...
									case SUB_NORMAL:
									case DOM_ROUGH:
										sb.append("[npc.SexPaceVerb] wrapping [npc.her] [npc.fingers] around [npc2.namePos] [npc2.hand+], [npc.name] started holding [npc2.her] [npc2.hand].");
										break;
									case SUB_RESISTING:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")+" as [npc.name] held [npc2.her] [npc2.hand].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.fingers+] wrapped around [npc2.namePos] [npc2.cock+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")+" as [npc.name] jerked [npc2.herHim] off.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
				...
				switch((SexAreaOrifice)targetArea) {
					...
					case ANUS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.fingers+] stuffed deep in [npc2.namePos] [npc2.asshole+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fingered [npc2.her] [npc2.asshole+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case BREAST:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept hold of [npc2.namePos] [npc2.breasts+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] groped [npc2.her] [npc2.breasts].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case BREAST_CROTCH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept hold of [npc2.namePos] [npc2.crotchBoobs+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] groped [npc2.her] [npc2.crotchBoobs].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.fingers+] pinched around [npc2.namePos] [npc2.nipples+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] played with [npc2.her] [npc2.nipples].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE_CROTCH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.fingers+] pinched around [npc2.namePos] [npc2.crotchNipples+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] played with [npc2.her] [npc2.crotchNipples].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.fingers+] stuffed deep in [npc2.namePos] [npc2.pussy+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fingered [npc2.her] [npc2.pussy+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case SPINNERET:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.fingers+] stuffed deep in [npc2.namePos] spinneret.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] fingered [npc2.her] web-spinning orifice.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
			...
			if(targetArea.isPenetration()) {
				switch((SexAreaPenetration)targetArea) {
					...
					case PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.feet+] pressed against [npc2.namePos] [npc2.cock+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")
										+" as [npc.namePos] gave [npc2.herHim] [npc.a_footjob].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
				...
				switch((SexAreaOrifice)targetArea) {
					...
					case MOUTH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.feet+] pressed against [npc2.namePos] face.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.namePos] [npc.feet+] smothered [npc2.her] face.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
			...
			if(targetArea.isPenetration()) {
				switch((SexAreaPenetration)targetArea) {
					case CLIT:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.tail+] pressed down between [npc2.namePos] [npc2.labia] and over [npc2.her] [npc2.clit+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")
										+" as [npc.name] prepared to tail-fuck [npc2.herHim].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.tail+] wrapped around [npc2.namePos] [npc2.cock+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")
										+" as [npc.namePos] gave [npc2.herHim] a tailjob.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
				...
				switch((SexAreaOrifice)targetArea) {
					...
					case ANUS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tail+] thrust deep in [npc2.namePos] [npc2.asshole+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tail-fucked [npc2.her] [npc2.asshole+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case MOUTH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tail+] thrust deep down [npc2.namePos] throat.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tail-fucked [npc2.her] face.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tail+] thrust deep in [npc2.namePos] [npc2.nipple(true)].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tail-fucked [npc2.her] [npc2.nipple(true)].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE_CROTCH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tail+] thrust deep in [npc2.namePos] [npc2.crotchNipple(true)].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
									...
									case SUB_NORMAL:
									case DOM_ROUGH:
										sb.append("[npc.Name] [npc.sexPaceVerb] pushed [npc.her] [npc.tail] against one of [npc2.namePos] [npc2.crotchNipples+], before thrusting forwards and tail-fucking [npc2.her] [npc2.crotchBoob+(true)].");
										break;
									case SUB_RESISTING:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tail-fucked [npc2.her] [npc2.crotchNipple(true)].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
									...
									case SUB_NORMAL:
									case DOM_ROUGH:
										sb.append(" [npc2.Name] [npc2.sexPaceVerb] pushed out [npc2.her] groin on every thrust, [npc2.moaning+] as [npc2.she] helped to sink [npc.namePos] [npc.tail+] deep into [npc2.her] [npc2.crotchNipple(true)].");
										break;
									case SUB_RESISTING:
										sb.append(" [npc2.Name] tried to pull away, but [npc.name] [npc.was] able to keep [npc2.herHim] in place even while [npc.her] [npc.tail+] thrust in and out of [npc2.her] [npc2.crotchNipple+(true)].");
										break;
								}
							}
					...
					case URETHRA_PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tail+] thrust deep in [npc2.namePos] [npc2.penisUrethra+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tail-fucked [npc2.her] [npc2.penisUrethra+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case URETHRA_VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tail+] thrust deep in [npc2.namePos] [npc2.vaginaUrethra+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tail-fucked [npc2.her] [npc2.vaginaUrethra+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tail+] thrust deep in [npc2.namePos] [npc2.pussy+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tail-fucked [npc2.her] [npc2.pussy+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case SPINNERET:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tail+] thrust deep in [npc2.namePos] spinneret.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tail-fucked [npc2.her] spinneret.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
			...
			if(targetArea.isPenetration()) {
				switch((SexAreaPenetration)targetArea) {
					case CLIT:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.tentacle+] pressed down between [npc2.namePos] [npc2.labia] and over [npc2.her] [npc2.clit+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")
										+" as [npc.name] prepared to tentacle-fuck [npc2.herHim].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] kept [npc.her] [npc.tentacle+] wrapped around [npc2.namePos] [npc2.cock+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and didn't come close to waking up":"continued to act like an inanimate sex toy, and didn't react at all")
										+" as [npc.namePos] gave [npc2.herHim] a tentaclejob.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
				...
				switch((SexAreaOrifice)targetArea) {
					...
					case ANUS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tentacle+] thrust deep in [npc2.namePos] [npc2.asshole+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tentacle-fucked [npc2.her] [npc2.asshole+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case MOUTH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tentacle+] thrust deep down [npc2.namePos] throat.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tentacle-fucked [npc2.her] face.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tentacle+] thrust deep in [npc2.namePos] [npc2.nipple(true)].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tentacle-fucked [npc2.her] [npc2.nipple(true)].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case NIPPLE_CROTCH:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tentacle+] thrust deep in [npc2.namePos] [npc2.crotchNipple(true)].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tentacle-fucked [npc2.her] [npc2.crotchNipple(true)].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case URETHRA_PENIS:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tentacle+] thrust deep in [npc2.namePos] [npc2.penisUrethra+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tentacle-fucked [npc2.her] [npc2.penisUrethra+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case URETHRA_VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tentacle+] thrust deep in [npc2.namePos] [npc2.vaginaUrethra+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tentacle-fucked [npc2.her] [npc2.vaginaUrethra+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case VAGINA:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tentacle+] thrust deep in [npc2.namePos] [npc2.pussy+].");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tentacle-fucked [npc2.her] [npc2.pussy+].");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
					...
					case SPINNERET:
						if(pastTense) {
							if(isCharacterInanimate(performer)) {
								sb.append("Remaining "+(performer.isAsleep()?"asleep":"motionless")+", [npc.name] didn't react at all as [npc.she] kept [npc.her] [npc.tentacle+] thrust deep in [npc2.namePos] spinneret.");
							} else {
								switch(performerPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
							...
							if(isCharacterInanimate(target)) {
								sb.append(" [npc2.Name] "+(target.isAsleep()?"remained deeply asleep, and showed no sign of being close to waking up":"continued to act like an inanimate sex toy, and remained totally motionless")
										+" while [npc.name] tentacle-fucked [npc2.her] spinneret.");
							} else {
								switch(targetPace) {
									case DOM_GENTLE:
									case DOM_NORMAL:
