...
public class SelfFingerTail {
	...
	public static final SexAction SELF_FINGER_VAGINA_SPREAD_PUSSY = new SexAction(
			...
			Util.newHashMapOfValues(new Value<>(SexAreaPenetration.FINGER, SexAreaOrifice.TAIL_PUSSY)),
		...
		public String getActionDescription() {
			return "Use your [npc.fingers] to spread your tail pussy.";
		}
		...
		public void applyEffects() {
			Main.sex.transferLubrication(Main.sex.getCharacterPerformingAction(), SexAreaPenetration.FINGER, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.TAIL_PUSSY);
		}
	};
	
	public static final SexAction SELF_FINGER_TAIL_PUSSY_PENETRATION = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Finger [npc.her] tail pussy";
		}
	...
	public static final SexAction DOM_SELF_FINGER_TAIL_PUSSY_GENTLE = new SexAction(
	...
	public static final SexAction DOM_SELF_FINGER_TAIL_PUSSY_NORMAL = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.THREE_NORMAL,
			ArousalIncrease.ONE_MINIMUM,
			CorruptionLevel.ZERO_PURE,
	...
	public static final SexAction DOM_SELF_FINGER_TAIL_PUSSY_ROUGH = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.THREE_NORMAL,
			ArousalIncrease.ONE_MINIMUM,
			CorruptionLevel.ONE_VANILLA,
	...
	public static final SexAction SUB_SELF_FINGER_TAIL_PUSSY_NORMAL = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.THREE_NORMAL,
			ArousalIncrease.ONE_MINIMUM,
			CorruptionLevel.ZERO_PURE,
	...
	public static final SexAction SUB_SELF_FINGER_TAIL_PUSSY_EAGER = new SexAction(
			SexActionType.ONGOING,
			ArousalIncrease.THREE_NORMAL,
			ArousalIncrease.ONE_MINIMUM,
			CorruptionLevel.ZERO_PURE,
	...
	public static final SexAction SELF_FINGER_TAIL_PUSSY_STOP_PENETRATION = new SexAction(
